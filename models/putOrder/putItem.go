...
type JccPutItem struct {
	...
	Rdh                 string  `orm:"column(rdh);size(30)" description:"关联入库单号"`
...
func init() {
	orm.RegisterModel(new(JccPutItem))
}

func AddPutItem(db orm.Ormer,params *JccPutItem) error {
